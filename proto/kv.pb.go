...
const file_proto_kv_proto_rawDesc = "" +
	...
	"\x03Put\x12\x11.proto.PutRequest\x1a\x12.proto.PutResponse\"\x00\x127\n" +
	"\x06Delete\x12\x14.proto.DeleteRequest\x1a\x15.proto.DeleteResponse\"\x00B+Z)github.com/subash-0044/beaver-vault/protob\x06proto3"
...
var file_proto_kv_proto_depIdxs = []int32{
	0, // 0: proto.KeyValueStore.Get:input_type -> proto.GetRequest
	2, // 1: proto.KeyValueStore.Put:input_type -> proto.PutRequest
	4, // 2: proto.KeyValueStore.Delete:input_type -> proto.DeleteRequest
	1, // 3: proto.KeyValueStore.Get:output_type -> proto.GetResponse
	3, // 4: proto.KeyValueStore.Put:output_type -> proto.PutResponse
	5, // 5: proto.KeyValueStore.Delete:output_type -> proto.DeleteResponse
